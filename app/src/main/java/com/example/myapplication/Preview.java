...
public class Preview {
    ...
    public void openCamera() {
        ...
        try {
            backCameraId = Integer.parseInt(getBackFacingCameraId(manager));
            frontCameraId = Integer.parseInt(getFrontFacingCameraId(manager));
            ...
            if(permissionCamera == PackageManager.PERMISSION_DENIED) {
                ...
                manager.openCamera(String.valueOf(cameraID), mStateCallback, null);
            }
        } catch (CameraAccessException e) {
